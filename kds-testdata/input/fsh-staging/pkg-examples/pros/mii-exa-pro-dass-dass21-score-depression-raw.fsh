...
* code.coding[+] = https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/CodeSystem/mii-cs-pro-score-catalogue#dass21-depression-raw "DASS-21 Depression Raw Score"
* subject = Reference(mii-exa-pro-patient)
* valueQuantity = 12 '{score}' "{score}"
