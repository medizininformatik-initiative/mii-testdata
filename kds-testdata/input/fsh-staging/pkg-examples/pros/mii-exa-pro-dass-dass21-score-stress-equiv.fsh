...
* code.coding[+] = https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/CodeSystem/mii-cs-pro-score-catalogue#dass21-stress-equiv "DASS-21 Stress DASS-42 Equivalent Score"
* subject = Reference(mii-exa-pro-patient)
* valueQuantity = 22 '{score}' "{score}"
