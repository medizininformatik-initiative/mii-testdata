...
* code = https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/CodeSystem/mii-cs-pro-score-catalogue#eortc-qlq-c30-fa "EORTC QLQ-C30 Fatigue Score"
* subject = Reference(mii-exa-pro-patient)
* valueQuantity = 22.22 '{score}' "{score}"
