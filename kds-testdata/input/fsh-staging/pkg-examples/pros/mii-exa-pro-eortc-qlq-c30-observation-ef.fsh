...
* code = https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/CodeSystem/mii-cs-pro-score-catalogue#eortc-qlq-c30-ef "EORTC QLQ-C30 Emotional Functioning Score"
* subject = Reference(mii-exa-pro-patient)
* valueQuantity = 87.5 '{score}' "{score}"
