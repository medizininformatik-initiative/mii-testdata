...
* code = https://www.medizininformatik-initiative.de/fhir/ext/modul-pro/CodeSystem/mii-cs-pro-score-catalogue#eortc-qlq-c30-sf "EORTC QLQ-C30 Social Functioning Score"
* subject = Reference(mii-exa-pro-patient)
* valueQuantity = 91.67 '{score}' "{score}"
