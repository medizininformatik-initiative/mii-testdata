...
* identifier.value = "spez-kultur-vre-neg-1"
...
* status = #final
* code.coding = http://loinc.org#13316-5 "Vancomycin resistant enterococcus [Presence] in Specimen by Organism specific culture"
