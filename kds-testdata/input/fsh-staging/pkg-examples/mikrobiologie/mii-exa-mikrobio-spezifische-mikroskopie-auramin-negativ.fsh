...
* identifier.value = "spez-mikroskopie-auramin-neg-1"
...
* extension.valueCodeableConcept.coding = http://snomed.info/sct#104220003 "Rhodamine-auramine fluorochrome stain method"
* extension.valueCodeableConcept.coding.version = "http://snomed.info/sct/900000000000207008/version/20260701"
* performer = Reference(mii-exa-mikrobio-labor)
* status = #final
* code.coding = http://loinc.org#87243-2 "Microscopic observation [Presence] in Specimen by Auramine fluorochrome stain"
