...
* identifier.value = "spez-best-vre-neg-1"
...
* status = #final
* code.coding = http://loinc.org#105904-7 "Vancomycin resistant enterococcus [Presence] in Specimen"
...
* method.coding = http://snomed.info/sct#70601000052104 "Real-time polymerase chain reaction technique (qualifier value)"
