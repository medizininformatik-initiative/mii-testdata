...
* identifier.value = "pathogenlast-1"
...
* valueQuantity = 350000 '1/mL' "Copies/mL"
* status = #final
* code.coding = http://loinc.org#33006-8 "Cytomegalovirus DNA [#/volume] (viral load) in Specimen by NAA with probe detection"
