...
* series.extension.extension[=].valueQuantity.unit = "Megabecquerel"
...
* series.extension.url = "https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/StructureDefinition/mii-ex-bildgebung-modalitaet-nm"
...
* series.instance.extension.extension[=].valueCodeableConcept.coding[+] = https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/CodeSystem/mii-cs-bildgebung-instance-image-type#DYNAMIC
* series.instance.extension.extension[=].valueCodeableConcept.coding[+] = https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/CodeSystem/mii-cs-bildgebung-instance-image-type#EMISSION
...
* series.number = 1
* series.modality = http://dicom.nema.org/resources/ontology/DCM#NM "Nuclear Medicine"
...
* status = #available
* modality = http://dicom.nema.org/resources/ontology/DCM#NM "Nuclear Medicine"
