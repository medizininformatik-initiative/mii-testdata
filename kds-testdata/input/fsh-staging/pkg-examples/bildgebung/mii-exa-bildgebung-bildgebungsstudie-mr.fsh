...
* series.instance.extension.extension[0].valueQuantity.value = 0.260417
* series.instance.extension.extension[=].valueQuantity.unit = "millimeter"
* series.instance.extension.extension[=].url = "pixelSpacingX"
* series.instance.extension.extension[+].valueQuantity.value = 0.260417
* series.instance.extension.extension[=].valueQuantity.unit = "millimeter"
* series.instance.extension.extension[=].url = "pixelSpacingY"
* series.instance.extension.extension[+].valueQuantity.value = 3
* series.instance.extension.extension[=].valueQuantity.unit = "millimeter"
...
* series.instance.extension.extension[=].valueCodeableConcept.coding[+] = https://www.medizininformatik-initiative.de/fhir/ext/modul-bildgebung/CodeSystem/mii-cs-bildgebung-instance-image-type#OTHER
