...
* status = #final
* code.coding = http://snomed.info/sct#251920002 "Maximum expiratory flow rate at 50 percent of vital capacity (observable entity)"
...
* component[=].valueQuantity = 4.76 'L/s'
