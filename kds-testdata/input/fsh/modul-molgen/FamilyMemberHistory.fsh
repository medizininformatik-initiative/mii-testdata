...
* reasonCode.coding[icd10-gm].display = "Boesartige Neubildung des Rektums, Anus und Analkanals: Rektum, Anus und Analkanal, mehrere Teilbereiche ueberlappend"
...
* condition[0].code.coding[icd10-gm].display = "Boesartiges Melanom der Haut, nicht naeher bezeichnet"
...
* reasonCode.coding[icd10-gm].display = "Boesartige Neubildung: Magen, nicht naeher bezeichnet"
...
* condition[0].code.coding[icd10-gm].display = "Boesartige Neubildung: Brustdruese, nicht naeher bezeichnet"
* condition[=].contributedToDeath = true
