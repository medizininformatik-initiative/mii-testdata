...
* insert AddBundleEntry(mii-exa-test-data-lungenfunktion-untersuchung-1, Procedure)
* insert AddBundleEntry(mii-exa-test-data-lungenfunktion-docref-rohdaten-1, DocumentReference)
* insert AddBundleEntry(mii-exa-test-data-lungenfunktion-methacholine-anordnung-1, MedicationRequest)
