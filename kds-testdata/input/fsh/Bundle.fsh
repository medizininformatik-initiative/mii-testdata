...
* insert AddBundleEntry(mii-exa-test-data-patient-1-specimen-3, Specimen)
* insert AddBundleEntry(mii-exa-test-data-specimen-documentrefence-1, DocumentReference)
* insert AddBundleEntry(mii-exa-test-data-specimen-documentrefence-2, DocumentReference)
