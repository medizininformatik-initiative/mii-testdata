...
* insert AddBundleEntry(mii-exa-test-data-onko-mamma-verlauf, Observation)
* insert AddBundleEntry(mii-exa-test-data-onko-mamma-fernmetastasen, Observation)
* insert AddBundleEntry(mii-exa-test-data-onko-mamma-residualstatus, Observation)
* insert AddBundleEntry(mii-exa-test-data-onko-mamma-ecog, Observation)
* insert AddBundleEntry(mii-exa-test-data-onko-mamma-karnofsky, Observation)
// tnm kategorien
* insert AddBundleEntry(mii-exa-test-data-onko-mamma-tnm-klassifikation, Observation)
* insert AddBundleEntry(mii-exa-test-data-onko-mamma-tnm-t-kategorie, Observation)
* insert AddBundleEntry(mii-exa-test-data-onko-mamma-tnm-n-kategorie, Observation)
* insert AddBundleEntry(mii-exa-test-data-onko-mamma-tnm-m-kategorie, Observation)
* insert AddBundleEntry(mii-exa-test-data-onko-mamma-tnm-l-kategorie, Observation)
* insert AddBundleEntry(mii-exa-test-data-onko-mamma-tnm-pn-kategorie, Observation)
* insert AddBundleEntry(mii-exa-test-data-onko-mamma-tnm-s-kategorie, Observation)
* insert AddBundleEntry(mii-exa-test-data-onko-mamma-tnm-v-kategorie, Observation)
// tnm symbole
* insert AddBundleEntry(mii-exa-test-data-onko-mamma-tnm-a-symbol, Observation)
