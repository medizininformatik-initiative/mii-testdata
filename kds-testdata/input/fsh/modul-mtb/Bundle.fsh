...
* insert AddBundleEntry(mii-exa-test-data-mtb-diagnose-primaertumor-2, Condition)
* insert AddBundleEntry(mii-exa-test-data-mtb-diagnose-primaertumor-3, Condition)
* insert AddBundleEntry(mii-exa-test-data-mtb-diagnose-primaertumor-4, Condition)
...
* insert AddBundleEntry(mii-exa-test-data-mtb-studie-group-1, Group)
...
* insert AddBundleEntry(mii-exa-test-data-mtb-systemische-therapie-medstatement-2, MedicationStatement)
* insert AddBundleEntry(mii-exa-test-data-mtb-systemische-therapie-medstatement-3, MedicationStatement)
* insert AddBundleEntry(mii-exa-test-data-mtb-response-befund-1, Observation)
* insert AddBundleEntry(mii-exa-test-data-mtb-fernmetastasen-1, Observation)
* insert AddBundleEntry(mii-exa-test-data-mtb-antrag-kostenuebernahme-1, Claim)
* insert AddBundleEntry(mii-exa-test-data-mtb-antrag-kostenuebernahme-2, Claim)
...
* insert AddBundleEntry(mii-exa-test-data-mtb-evidenz-liste-1, List)
