...
// Diagnose zu Patient 3 — Grundlage der Gewebeprobe und des daraus
// etablierten Kolon-Tumor-Organoids (extension:festgestellteDiagnose)
Instance: mii-exa-test-data-biobank-diagnose-3
InstanceOf: https://www.medizininformatik-initiative.de/fhir/core/modul-diagnose/StructureDefinition/Diagnose
Usage: #example
