...
* extension[+].url = "https://fhir.bbmri-eric.eu/fhir/StructureDefinition/miabis-collection-design-extension"
* extension[=].valueCodeableConcept = https://fhir.bbmri-eric.eu/fhir/CodeSystem/miabis-collection-design-cs#LongitudinalCohort "Longitudinal cohort"
* extension[+].url = "https://fhir.bbmri-eric.eu/fhir/StructureDefinition/miabis-sample-collection-setting-extension"
* extension[=].valueCodeableConcept = https://fhir.bbmri-eric.eu/fhir/CodeSystem/miabis-sample-collection-setting-cs#RoutineHealthCare "Routine health care setting"
