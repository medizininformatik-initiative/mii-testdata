...
* insert AddBundleEntry(mii-exa-test-data-onko-diagnose-4, Condition)
...
* insert AddBundleEntry(mii-exa-test-data-onko-tnm-n-kategorie-3, Observation)
* insert AddBundleEntry(mii-exa-test-data-onko-tnm-t-kategorie-4, Observation)
* insert AddBundleEntry(mii-exa-test-data-onko-tnm-m-kategorie-3, Observation)
* insert AddBundleEntry(mii-exa-test-data-onko-tnm-n-kategorie-4, Observation)
* insert AddBundleEntry(mii-exa-test-data-onko-tnm-m-kategorie-4, Observation)
