# mii-exa-test-data-medication-5-fluorouracil - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-medication-5-fluorouracil**

## Example Medication: mii-exa-test-data-medication-5-fluorouracil
...
| :--- | :--- | :--- |
| - | **Item[x]** | **Strength** |
| * | Fluorouracil | 1000 mg (Details: UCUM codemg = 'mg')/20 ml (Details: UCUM codeml = 'ml') |
...
```json
{
  ...
  "id" : "mii-exa-test-data-medication-5-fluorouracil",
  "meta" : {
