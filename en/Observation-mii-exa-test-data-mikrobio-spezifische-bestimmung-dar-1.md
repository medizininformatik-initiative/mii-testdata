# mii-exa-test-data-mikrobio-spezifische-bestimmung-dar-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-mikrobio-spezifische-bestimmung-dar-1**

## Example Observation: mii-exa-test-data-mikrobio-spezifische-bestimmung-dar-1
...
**identifier**: Observation Instance Identifier/spezifische-bestimmung-dar-1

**status**: Final

**category**: Laboratory, Microbiology

**code**: Escherichia coli DNA [Presence] in Specimen by NAA with probe detection
