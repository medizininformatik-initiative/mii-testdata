# MTB Studieneinschluss Anfrage (abgelehnt) - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MTB Studieneinschluss Anfrage (abgelehnt)**

## Example ServiceRequest: MTB Studieneinschluss Anfrage (abgelehnt)
...
**Request status reason**: Studieneinschluss nicht erfolgt - Patient vor Screening verstorben

**MII EX MTB Empfehlung Priorität**: 3.2
