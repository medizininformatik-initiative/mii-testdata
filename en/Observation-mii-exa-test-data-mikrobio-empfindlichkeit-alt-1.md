# mii-exa-test-data-mikrobio-empfindlichkeit-alt-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-mikrobio-empfindlichkeit-alt-1**

## Example Observation: mii-exa-test-data-mikrobio-empfindlichkeit-alt-1
...
**identifier**: Observation Instance Identifier/empfindlichkeit-alt-1

**status**: Final

**category**: Laboratory, Microbiology

**code**: Cefozopran [Susceptibility]
...
**value**: >8 mg/L (Details: UCUM codemg/L = 'mg/L')
...
Alt-Variante zur MS-Coverage (empfindlichkeit)
