# mii-exa-test-data-patient-5-labreport-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-patient-5-labreport-1**

## Example DiagnosticReport: mii-exa-test-data-patient-5-labreport-1
...
| | |
| :--- | :--- |
| Subject | Sabine Maria Weber (official) Female, DoB: 1985-03-12 ( Medical record number (use: usual, )) |
| Relevant Time | 2023-07-12 06:45:00+0200 |
| Reported | 2023-07-12 10:15:00+0200 |
| Performer | [Organization Labor Berlin – Charité Vivantes GmbH](Organization-mii-exa-test-data-organization-labor-berlin.md) |
| Identifier | Filler Identifier/LDR_000005 |

**Report Details**

* **Code**: [Leukocytes [#/volume] in Blood](Observation-mii-exa-test-data-patient-5-labobs-1.md)
  * **Value**: 7.8 /nanoliter (Details: UCUM code/nL = '/nL')
  * **Flags**: Final,Normal
  * **Reported**: 2023-07-12 08:30:00+0200
* **Code**: [Hemoglobin [Mass/volume] in Blood](Observation-mii-exa-test-data-patient-5-labobs-2.md)
  * **Value**: 11.8 gram per deciliter (Details: UCUM codeg/dL = 'g/dL')
  * **Flags**: Final,Low
  * **Reported**: 2023-07-12 08:30:00+0200
* **Code**: [Fasting glucose [Mass/volume] in Serum or Plasma](Observation-mii-exa-test-data-patient-5-labobs-3.md)
  * **Value**: 92 milligram per deciliter (Details: UCUM codemg/dL = 'mg/dL')
  * **Flags**: Final,Normal
  * **Reported**: 2023-07-12 08:30:00+0200

Leichte Anämie (Hb 11,8 g/dL) bei normoglykämischen Nüchternwerten (92 mg/dL). Eisenmangel-Anämie bei Endometriose-Patientin wahrscheinlich.
...
```json
{
  ...
  "id" : "mii-exa-test-data-patient-5-labreport-1",
  "meta" : {
