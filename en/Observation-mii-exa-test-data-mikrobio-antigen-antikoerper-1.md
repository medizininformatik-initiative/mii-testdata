# mii-exa-test-data-mikrobio-antigen-antikoerper-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-mikrobio-antigen-antikoerper-1**

## Example Observation: mii-exa-test-data-mikrobio-antigen-antikoerper-1
...
Profile: [MII PR Mikrobio Antigen Antikoerper Quantitativ](https://simplifier.net/resolve?scope=de.medizininformatikinitiative.kerndatensatz.complete@2027.0.0-ballot.19&canonical=https://www.medizininformatik-initiative.de/fhir/modul-mikrobio/StructureDefinition/mii-pr-mikrobio-antigen-antikoerper-quantitativ)

Security Label: [test health data (Details: ActReason code HTEST = 'test health data')](http://terminology.hl7.org/7.4.0/CodeSystem-v3-ActReason.html)

**MII EX Labor Interpretationsbeeinflussende Eigenschaft**: [SNOMED CT: 118128002](http://snomed.info/id/118128002) (Specimen hemolyzed (finding))

**identifier**: Observation Instance Identifier/antigen-ak-1
...
**code**: Borrelia burgdorferi Ab [Units/volume] in Serum by Immunoassay
...
**effective**: 2026-04-05 09:00:00+0200

**issued**: 2026-04-05 10:00:00+0200

**value**: >42 [IU]/mL (Details: UCUM code[IU]/mL = '[IU]/mL')
...
Borrelien-Antikörper nachweisbar. Klinische Korrelation empfohlen.


**method**: Immunoassay technique (qualifier value)
...
| :--- | :--- | :--- |
| - | **Low** | **High** |
| * | 0 [IU]/mL (Details: UCUM code[IU]/mL = '[IU]/mL') | 10 [IU]/mL (Details: UCUM code[IU]/mL = '[IU]/mL') |
