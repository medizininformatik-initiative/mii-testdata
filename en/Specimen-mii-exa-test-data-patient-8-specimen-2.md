# mii-exa-test-data-patient-8-specimen-2 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-patient-8-specimen-2**

## Example Specimen: mii-exa-test-data-patient-8-specimen-2
...
**identifier**: `https://www.charite.de/fhir/sid/Bioproben`/BP_000015

**status**: Available

**type**: Serum specimen (specimen)

**subject**: [Heinrich Plasma Male, DoB: 1969-07-28 ( https://www.charite.de/fhir/sid/patientenidentifikation#BIO-TEST-008)](Patient-mii-exa-test-data-biobank-patient-8.md)
...
| * | 2023-11-12 05:45:00+0100 | Right upper arm structure (body structure) |
