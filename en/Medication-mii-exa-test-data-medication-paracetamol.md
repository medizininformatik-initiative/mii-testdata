# mii-exa-test-data-medication-paracetamol - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-medication-paracetamol**

## Example Medication: mii-exa-test-data-medication-paracetamol
...
| :--- | :--- | :--- |
| - | **Item[x]** | **Strength** |
| * | Paracetamol | 500 mg (Details: UCUM codemg = 'mg')/1 1 (Details: UCUM code1 = '1') |
...
```json
{
  ...
  "id" : "mii-exa-test-data-medication-paracetamol",
  "meta" : {
