# mii-exa-test-data-mikrobio-keimzahl-alt-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-mikrobio-keimzahl-alt-1**

## Example Observation: mii-exa-test-data-mikrobio-keimzahl-alt-1
...
**identifier**: Observation Instance Identifier/keimzahl-alt-1
...
**value**: >=10000 /mL (Details: UCUM code/mL = '/mL')
...
Alt-Variante zur MS-Coverage (keimzahl)
