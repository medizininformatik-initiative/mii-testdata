# mii-exa-test-data-patient-3-labobs-3 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-patient-3-labobs-3**

## Example Observation: mii-exa-test-data-patient-3-labobs-3
...
**identifier**: Observation Instance Identifier/LO_000013

**basedOn**: [ServiceRequest CBC panel - Blood by Automated count](ServiceRequest-mii-exa-test-data-patient-3-labrequest-1.md)

**status**: Final

**category**: Laboratory

**code**: Bilirubin.total [Mass/volume] in Serum or Plasma
...
**effective**: 2022-04-05 08:00:00+0200

**issued**: 2022-04-05 10:30:00+0200
...
```json
{
  ...
  "id" : "mii-exa-test-data-patient-3-labobs-3",
  "meta" : {
  ...
  "issued" : "2022-04-05T10:30:00+02:00",
  "valueQuantity" : {
    "value" : 2.8,
