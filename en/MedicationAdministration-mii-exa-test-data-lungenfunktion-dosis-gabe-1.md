# mii-exa-test-data-lungenfunktion-dosis-gabe-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-lungenfunktion-dosis-gabe-1**

## Example MedicationAdministration: mii-exa-test-data-lungenfunktion-dosis-gabe-1
...
**identifier**: `https://www.charite.de/fhir/sid/MedicationAdministrations`/lufu-dosis-gabe-1
...
**effective**: 2025-02-18 11:05:00+0100
...
Erste Dosisstufe des Provokationsprotokolls.
...
| * | 0,04 mg Methacholin inhalativ ueber Dosimeter-Vernebler | Mouth region structure (body structure) | Respiratory tract route (qualifier value) | 0.04 mg (Details: UCUM codemg = 'mg') | 0.5 mL/min (Details: UCUM codemL/min = 'mL/min') |
