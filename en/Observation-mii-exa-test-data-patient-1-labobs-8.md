# mii-exa-test-data-patient-1-labobs-8 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-patient-1-labobs-8**

## Example Observation: mii-exa-test-data-patient-1-labobs-8
...
**identifier**: Observation Instance Identifier/LO_000036

**status**: Final

**category**: Laboratory

**code**: Nitrite [Presence] in Urine by Test strip
...
**method**: Test strip technique (qualifier value)
