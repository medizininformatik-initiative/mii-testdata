# mii-exa-test-data-lungenfunktion-lufttemperatur-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-lungenfunktion-lufttemperatur-1**

## Example Observation: mii-exa-test-data-lungenfunktion-lufttemperatur-1
...
Profile: [MII PR Lungenfunktion Lufttemperatur](https://simplifier.net/resolve?scope=de.medizininformatikinitiative.kerndatensatz.complete@2027.0.0-ballot.19&canonical=https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-lufttemperatur)
...
**value**: 21.5 Cel (Details: UCUM codeCel = 'Cel')
