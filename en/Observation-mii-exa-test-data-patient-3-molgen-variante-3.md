# mii-exa-test-data-patient-3-molgen-variante-3 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-patient-3-molgen-variante-3**

## Example Observation: mii-exa-test-data-patient-3-molgen-variante-3
...
> **component****code**: DNA region name [Identifier]**value**: Exon 20

> **component****code**: DNA change (c.HGVS)**value**: NM_005228.5:c.2300_2308dup

> **component****code**: Amino acid change (pHGVS)**value**: p.(Ala767_Val769dup)

> **component****code**: Sample variant allelic frequency [NFr]**value**: 18.7 % (Details: UCUM code% = '%')
