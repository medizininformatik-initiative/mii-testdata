# mii-exa-test-data-patient-5-medadmin-2 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-patient-5-medadmin-2**

## Example MedicationAdministration: mii-exa-test-data-patient-5-medadmin-2
...
**identifier**: `https://www.charite.de/fhir/sid/MedicationAdministrations`/MA_0000012
...
**effective**: 2023-07-11 15:00:00+0200

**request**: [MedicationRequest: identifier = https://www.charite.de/fhir/sid/MedicationOrders#MO_0000014; status = active; intent = order; medication[x] = ->Medication Ibuprofen; authoredOn = 2023-07-11 09:30:00+0200](MedicationRequest-mii-exa-test-data-patient-5-medrequest-2.md)
...
| :--- | :--- | :--- | :--- |
| - | **Text** | **Route** | **Dose** |
| * | Ibuprofen 400mg oral bei Schmerzen | Oral use | 400 mg (Details: UCUM codemg = 'mg') |
...
```json
{
  ...
  "id" : "mii-exa-test-data-patient-5-medadmin-2",
  "meta" : {
  ...
  "dosage" : {
    "text" : "Ibuprofen 400mg oral bei Schmerzen",
    "route" : {
      "coding" : [{
