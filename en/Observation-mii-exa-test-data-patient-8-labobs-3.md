# mii-exa-test-data-patient-8-labobs-3 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-patient-8-labobs-3**

## Example Observation: mii-exa-test-data-patient-8-labobs-3
...
**identifier**: Observation Instance Identifier/LO_000028

**basedOn**: [ServiceRequest Troponin T.cardiac panel - Serum or Plasma by High sensitivity method](ServiceRequest-mii-exa-test-data-patient-8-labrequest-1.md)

**status**: Final

**category**: Laboratory

**code**: Creatine kinase [Enzymatic activity/volume] in Serum or Plasma
...
**effective**: 2023-11-12 06:30:00+0100

**issued**: 2023-11-12 08:15:00+0100
