# mii-exa-test-data-mikrobio-spezifische-bestimmung-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-mikrobio-spezifische-bestimmung-1**

## Example Observation: mii-exa-test-data-mikrobio-spezifische-bestimmung-1
...
Profile: [MII PR Mikrobio Spezifische Bestimmung](https://simplifier.net/resolve?scope=de.medizininformatikinitiative.kerndatensatz.complete@2027.0.0-ballot.19&canonical=https://www.medizininformatik-initiative.de/fhir/modul-mikrobio/StructureDefinition/mii-pr-mikrobio-spezifische-bestimmung)
...
**identifier**: Observation Instance Identifier/spez-bestimmung-1
...
**code**: Staphylococcus aureus [Presence] in Specimen by Organism specific culture
...
**effective**: 2026-04-03 15:00:00+0200

**issued**: 2026-04-03 16:00:00+0200
...
Identifikation via spezifische Kultur.


**method**: Organism specific culture technique (qualifier value)
