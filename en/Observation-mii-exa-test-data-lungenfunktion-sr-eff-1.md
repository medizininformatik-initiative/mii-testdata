# mii-exa-test-data-lungenfunktion-sr-eff-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-lungenfunktion-sr-eff-1**

## Example Observation: mii-exa-test-data-lungenfunktion-sr-eff-1
...
Profile: [MII PR Lungenfunktion R Effektiv](https://simplifier.net/resolve?scope=de.medizininformatikinitiative.kerndatensatz.complete@2027.0.0-ballot.19&canonical=https://www.medizininformatik-initiative.de/fhir/ext/modul-lungenfunktion/StructureDefinition/mii-pr-lungenfunktion-r-effektiv)
...
**value**: 1.1 kPa.s (Details: UCUM codekPa.s = 'kPa.s')
...
**hasMember**: [Observation Total airway resistance (observable entity)](Observation-mii-exa-test-data-lungenfunktion-r-1.md)
...
| :--- | :--- | :--- |
| - | **Code** | **Value[x]** |
| * | Specific effective resistance.airway/Predicted mean | 115 % (Details: UCUM code% = '%') |
