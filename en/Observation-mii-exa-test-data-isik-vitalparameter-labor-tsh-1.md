# mii-exa-test-data-isik-vitalparameter-labor-tsh-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-isik-vitalparameter-labor-tsh-1**

## Example Observation: mii-exa-test-data-isik-vitalparameter-labor-tsh-1

Information Source: [https://www.charite.de/fhir/kds-testdata](https://simplifier.net/resolve?scope=de.medizininformatikinitiative.kerndatensatz.complete@2027.0.0-ballot.19&canonical=https://www.charite.de/fhir/kds-testdata)

Profile: [ISiKLaboruntersuchungTSH](https://simplifier.net/resolve?scope=de.medizininformatikinitiative.kerndatensatz.icu@2027.0.0-ballot.3&canonical=https://gematik.de/fhir/isik/StructureDefinition/ISiKLaboruntersuchungTSH)

Security Label: [test health data (Details: ActReason code HTEST = 'test health data')](http://terminology.hl7.org/7.4.0/CodeSystem-v3-ActReason.html)

**identifier**: Observation Instance Identifier/ISIK-VITAL-LAB-007

**status**: Final

**category**: Laboratory

**code**: TSH basal (Serum)
...
**value**: 1.8 milli IU per liter (Details: UCUM codem[IU]/L = 'm[IU]/L')
...
| :--- | :--- | :--- | :--- |
| - | **Low** | **High** | **Type** |
| * | 0.4 milli IU per liter (Details: UCUM codem[IU]/L = 'm[IU]/L') | 4 milli IU per liter (Details: UCUM codem[IU]/L = 'm[IU]/L') | Normal Range |
