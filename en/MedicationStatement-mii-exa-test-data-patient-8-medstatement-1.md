# mii-exa-test-data-patient-8-medstatement-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-patient-8-medstatement-1**

## Example MedicationStatement: mii-exa-test-data-patient-8-medstatement-1
...
**identifier**: `https://www.charite.de/fhir/sid/MedicationStatements`/MS_0000021

**basedOn**: [MedicationRequest: identifier = https://www.charite.de/fhir/sid/MedicationOrders#MO_0000020; status = active; intent = order; medication[x] = ->Medication Heparin; authoredOn = 2023-11-12 08:00:00+0100](MedicationRequest-mii-exa-test-data-patient-8-medrequest-1.md)
...
**effective**: 2023-11-12 08:00:00+0100 --> 2023-11-15 14:00:00+0100

**dateAsserted**: 2023-11-12

> **dosage****text**: Heparin 5000 IE s.c. alle 12 Stunden**timing**: 2 per 1 day**route**: Subcutaneous use
