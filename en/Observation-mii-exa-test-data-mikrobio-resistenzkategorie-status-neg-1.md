# mii-exa-test-data-mikrobio-resistenzkategorie-status-neg-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-mikrobio-resistenzkategorie-status-neg-1**

## Example Observation: mii-exa-test-data-mikrobio-resistenzkategorie-status-neg-1
...
**identifier**: Observation Instance Identifier/resistenzkategorie-status-neg-1
...
MRSA nicht nachgewiesen (negatives Screening-Ergebnis).
