# mii-exa-test-data-patient-8-medstatement-3 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-patient-8-medstatement-3**

## Example MedicationStatement: mii-exa-test-data-patient-8-medstatement-3
...
**basedOn**: [MedicationRequest: identifier = https://www.charite.de/fhir/sid/MedicationOrders#MO_0000022; status = active; intent = order; medication[x] = ->Medication Atorvastatin; authoredOn = 2023-11-12 09:00:00+0100](MedicationRequest-mii-exa-test-data-patient-8-medrequest-3.md)
...
**effective**: 2023-11-12 09:00:00+0100 --> 2023-11-15 14:00:00+0100

**dateAsserted**: 2023-11-12

> **dosage****text**: Atorvastatin 40mg 1x täglich abends**timing**: Evening, Once per 1 day**route**: Oral use
