# mii-exa-test-data-patient-7-specimen-2 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-patient-7-specimen-2**

## Example Specimen: mii-exa-test-data-patient-7-specimen-2
...
**identifier**: `https://www.charite.de/fhir/sid/Bioproben`/BP_000013

**status**: Available

**type**: Serum specimen (specimen)

**subject**: [Greta Serum Female, DoB: 1987-03-15 ( https://www.charite.de/fhir/sid/patientenidentifikation#BIO-TEST-007)](Patient-mii-exa-test-data-biobank-patient-7.md)
...
| * | 2024-01-10 07:30:00+0100 | Right upper arm structure (body structure) |
