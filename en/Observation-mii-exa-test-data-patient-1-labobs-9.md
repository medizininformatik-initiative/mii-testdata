# mii-exa-test-data-patient-1-labobs-9 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-patient-1-labobs-9**

## Example Observation: mii-exa-test-data-patient-1-labobs-9
...
**MII EX Labor Interpretationsbeeinflussende Eigenschaft**: [SNOMED CT: 118128002](http://snomed.info/id/118128002) (Specimen hemolyzed)

**identifier**: Observation Instance Identifier/LO_000039
...
**issued**: 2024-02-15 13:10:00+0100

**value**: <0.014 microgram per liter (Details: UCUM codeug/L = 'ug/L')
...
Troponin T unterhalb der Nachweisgrenze; Probe leicht haemolytisch.


**method**: Immunoassay method (qualifier value)
...
**device**: [Device: identifier = https://www.charite.de/fhir/sid/Laboratory-device-identifier#RocheCobasE402; status = active; manufacturer = Roche; modelNumber = e 402](Device-mii-exa-test-data-device-roche-cobas-e402.md)
