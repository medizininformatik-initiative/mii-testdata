# Nutzung - MII KDS Test Data v2027.0.0-ballot
...
Das gilt ausdrücklich auch für die **Kodierungen**: Codes (u.a. ICD-10-GM, OPS, SNOMED CT, LOINC, ATC) und deren Kombinationen wurden für Zwecke der technischen Strukturprüfung gewählt. Sie sind syntaktisch gültig und stammen aus den realen Katalogen, stellen aber **keine Kodier-, Abrechnungs- oder Dokumentationsempfehlung** dar — weder die klinische Passung eines Codes zum dargestellten Fall noch die Vollständigkeit der Kodierung ist zugesichert. Die Testdaten sind keine Referenz für korrektes Kodieren und **nicht als Grundlage für Forschung oder Versorgung geeignet**.
