# mii-exa-test-data-patient-5-prozedur-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-patient-5-prozedur-1**

## Example Procedure: mii-exa-test-data-patient-5-prozedur-1
...
**performed**: 2023-07-13 09:00:00+0200

**recorder**: [PractitionerRole Physician (occupation)](PractitionerRole-mii-exa-test-data-practitioner-role-physician-1.md)

**bodySite**: Entire anterior abdominal wall

**note**: 

> 

Diagnostische Laparoskopie zur Endometriose-Abklärung
...
```json
{
  ...
  "id" : "mii-exa-test-data-patient-5-prozedur-1",
  "meta" : {
  ...
  "note" : [{
    "text" : "Diagnostische Laparoskopie zur Endometriose-Abklärung"
  }]
}
