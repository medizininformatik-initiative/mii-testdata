# mii-exa-test-data-patient-3-molgen-therapeutische-implikation-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-patient-3-molgen-therapeutische-implikation-1**

## Example Observation: mii-exa-test-data-patient-3-molgen-therapeutische-implikation-1
...
> **component****code**: Conclusion Text**value**: Nachweis einer aktivierenden Mutation BRAF V600E. Triple-Therapie mit einem EGFR-Antikoerper sowie einem BRAF- und einem MEK-Inhibitor pruefen.

> **component****code**: Medication assessed [ID]**value**: BRAF Inhibitor

> **component****code**: Medication assessed [ID]**value**: EGFR (Epidermaler Wachstumsfaktor-Rezeptor)-Inhibitoren

> **component****code**: Medication assessed [ID]**value**: Mitogen-aktivierte Proteinkinase (MEK)-Inhibitoren

> **component****code**: Level of evidence**value**: Tier I - Level A (AMP/ASCO/CAP, FDA-approved therapy)

> **component****code**: Associated phenotype**value**: Adenocarcinoma of anorectum (disorder)
