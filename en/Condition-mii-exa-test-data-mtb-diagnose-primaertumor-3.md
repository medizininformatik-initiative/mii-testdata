# MTB Diagnose Primaertumor (Variante abatementAge) - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MTB Diagnose Primaertumor (Variante abatementAge)**

## Example Condition: MTB Diagnose Primaertumor (Variante abatementAge)
...
**Condition Asserted Date**: 2015-05-01
...
**code**: Sonstige bösartige Neubildungen: Haut sonstiger und nicht näher bezeichneter Teile des Gesichtes
...
**abatement**: 45 Jahre (Details: UCUM codea = 'a')
