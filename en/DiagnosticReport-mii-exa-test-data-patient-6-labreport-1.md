# mii-exa-test-data-patient-6-labreport-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-patient-6-labreport-1**

## Example DiagnosticReport: mii-exa-test-data-patient-6-labreport-1
...
| | |
| :--- | :--- |
| Subject | Thomas Michael Richter (official) Male, DoB: 1975-11-08 ( Medical record number (use: usual, )) |
| Relevant Time | 2022-03-14 07:00:00+0100 |
| Reported | 2022-03-14 11:45:00+0100 |
| Performer | [Organization Labor Berlin – Charité Vivantes GmbH](Organization-mii-exa-test-data-organization-labor-berlin.md) |
| Identifier | Filler Identifier/LDR_000006 |

**Report Details**

* **Code**: [Leukocytes [#/volume] in Blood](Observation-mii-exa-test-data-patient-6-labobs-1.md)
  * **Value**: 9.1 /nanoliter (Details: UCUM code/nL = '/nL')
  * **Flags**: Final,Normal
  * **Reported**: 2022-03-14 09:30:00+0100
* **Code**: [Alanine aminotransferase [Enzymatic activity/volume] in Serum or Plasma](Observation-mii-exa-test-data-patient-6-labobs-2.md)
  * **Value**: 45 unit per liter (Details: UCUM codeU/L = 'U/L')
  * **Flags**: Final,High
  * **Reported**: 2022-03-14 09:30:00+0100
* **Code**: [Aspartate aminotransferase [Enzymatic activity/volume] in Serum or Plasma](Observation-mii-exa-test-data-patient-6-labobs-3.md)
  * **Value**: 38 unit per liter (Details: UCUM codeU/L = 'U/L')
  * **Flags**: Final,High
  * **Reported**: 2022-03-14 09:30:00+0100

Hepatozelluläres Schädigungsmuster: Erhöhte Transaminasen (ALT 45 U/L, AST 38 U/L) bei chronischer Gastritis. Medikamenten-toxische oder inflammatorische Genese möglich.
