# mii-exa-test-data-patient-1-medadmin-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-patient-1-medadmin-1**

## Example MedicationAdministration: mii-exa-test-data-patient-1-medadmin-1
...
**identifier**: `https://www.charite.de/fhir/sid/MedicationAdministrations`/MA_0000001
...
| * | Dalbavancin 1500 mg als 30-minütige Infusion | Structure of dorsum of left hand (body structure) | Intravenous use | 1500 mg (Details: UCUM codemg = 'mg') | 1500 mg (Details: UCUM codemg = 'mg')/30 Minuten (Details: UCUM codemin = 'min') |
