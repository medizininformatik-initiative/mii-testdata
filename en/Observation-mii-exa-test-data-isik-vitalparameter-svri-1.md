# mii-exa-test-data-isik-vitalparameter-svri-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-isik-vitalparameter-svri-1**

## Example Observation: mii-exa-test-data-isik-vitalparameter-svri-1

Information Source: [https://www.charite.de/fhir/kds-testdata](https://simplifier.net/resolve?scope=de.medizininformatikinitiative.kerndatensatz.complete@2027.0.0-ballot.19&canonical=https://www.charite.de/fhir/kds-testdata)

Profile: [SD MII ICU Systemischer Vaskulaerer Widerstandsindex](https://simplifier.net/resolve?scope=de.medizininformatikinitiative.kerndatensatz.icu@2027.0.0-ballot.3&canonical=https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-systemischer-vaskulaerer-widerstandsindex)
...
**code**: Systemic vascular resistance index (observable entity)
...
**value**: 1900 dyne second per centimeter5 and square meter (Details: UCUM codedyn.s/cm5/m2 = 'dyn.s/cm5/m2')
