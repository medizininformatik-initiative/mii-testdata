# mii-exa-test-data-isik-vitalparameter-temp-hws-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-isik-vitalparameter-temp-hws-1**

## Example Observation: mii-exa-test-data-isik-vitalparameter-temp-hws-1

Information Source: [https://www.charite.de/fhir/kds-testdata](https://simplifier.net/resolve?scope=de.medizininformatikinitiative.kerndatensatz.complete@2027.0.0-ballot.19&canonical=https://www.charite.de/fhir/kds-testdata)

Profile: [SD MII ICU Koerpertemperatur Halswirbelsaeule](https://simplifier.net/resolve?scope=de.medizininformatikinitiative.kerndatensatz.icu@2027.0.0-ballot.3&canonical=https://gematik.de/fhir/isik/StructureDefinition/sd-mii-icu-koerpertemperatur-halswirbelsaeule)
...
**code**: Cervical spine temperature (observable entity)
...
**effective**: 2026-05-12 11:05:00+0200

**performer**: Pflegefachkraft Station 14i

**value**: 36.8 Grad Celsius (Details: UCUM codeCel = 'Cel')

**bodySite**: Cervical vertebral column structure (body structure)
