# mii-exa-test-data-mikrobio-aviditaet-alt-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-mikrobio-aviditaet-alt-1**

## Example Observation: mii-exa-test-data-mikrobio-aviditaet-alt-1
...
**identifier**: Observation Instance Identifier/aviditaet-alt-1

**status**: Final

**category**: Laboratory, Microbiology

**code**: Measles virus IgG Ab avidity [Ratio] in Serum by Immunoassay
...
Alt-Variante zur MS-Coverage (aviditaet)
