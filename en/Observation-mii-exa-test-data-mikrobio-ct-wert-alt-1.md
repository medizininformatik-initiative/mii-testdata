# mii-exa-test-data-mikrobio-ct-wert-alt-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-mikrobio-ct-wert-alt-1**

## Example Observation: mii-exa-test-data-mikrobio-ct-wert-alt-1
...
**identifier**: Observation Instance Identifier/ct-wert-alt-1
...
**value**: <30.5 Ct (Details: UCUM code1 = '1')
...
Alt-Variante zur MS-Coverage (ct-wert)
