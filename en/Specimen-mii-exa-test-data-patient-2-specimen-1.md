# mii-exa-test-data-patient-2-specimen-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-patient-2-specimen-1**

## Example Specimen: mii-exa-test-data-patient-2-specimen-1
...
**identifier**: `https://www.charite.de/fhir/sid/Bioproben`/BP_000003

**status**: Available

**type**: Blood specimen with edetic acid (specimen)

**subject**: [Martin Testfall Male, DoB: 1980-04-18 ( https://www.charite.de/fhir/sid/patientenidentifikation#BIO-TEST-002)](Patient-mii-exa-test-data-biobank-patient-2.md)
...
| * | 2024-03-04 06:45:00+0100 | Left upper arm structure (body structure) |
...
```json
{
  ...
  "id" : "mii-exa-test-data-patient-2-specimen-1",
  "meta" : {
  ...
  "collection" : {
    "collectedDateTime" : "2024-03-04T06:45:00+01:00",
    "bodySite" : {
      "coding" : [{
        "system" : "http://snomed.info/sct",
        "code" : "368208006",
