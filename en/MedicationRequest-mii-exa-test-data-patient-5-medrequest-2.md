# mii-exa-test-data-patient-5-medrequest-2 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-patient-5-medrequest-2**

## Example MedicationRequest: mii-exa-test-data-patient-5-medrequest-2
...
**identifier**: `https://www.charite.de/fhir/sid/MedicationOrders`/MO_0000014
...
**authoredOn**: 2023-07-11 09:30:00+0200

> **dosageInstruction****text**: Ibuprofen 400mg bis zu 3x täglich bei Bedarf**timing**: 3 per 1 day**asNeeded**: true**route**: Oral use
...
```json
{
  ...
  "id" : "mii-exa-test-data-patient-5-medrequest-2",
  "meta" : {
