# mii-exa-test-data-mikrobio-resistenzkategorie-status-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-mikrobio-resistenzkategorie-status-1**

## Example Observation: mii-exa-test-data-mikrobio-resistenzkategorie-status-1
...
**identifier**: Observation Instance Identifier/resistenzkategorie-status-1
...
**effective**: 2026-04-04 10:30:00+0200

**issued**: 2026-04-04 11:00:00+0200
...
MRSA-Befund (Methicillin-resistenter Staphylococcus aureus nachgewiesen) — Isolation noetig.
...
**derivedFrom**: [Observation Methicillin resistance mecA gene [Presence] by Molecular method](Observation-mii-exa-test-data-mikrobio-resistenzmechanismen-1.md)
