# mii-exa-test-data-patient-1-labobs-3 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-patient-1-labobs-3**

## Example Observation: mii-exa-test-data-patient-1-labobs-3
...
**identifier**: Observation Instance Identifier/LO_000003
...
**code**: Hematocrit [Volume Fraction] of Blood by calculation
...
Hämatokrit EDTA-Blut Impedanzmessung
...
| * | 40 percent (Details: UCUM code% = '%') | 51 percent (Details: UCUM code% = '%') | Normal Range | Male (finding) | 18-65 year |
