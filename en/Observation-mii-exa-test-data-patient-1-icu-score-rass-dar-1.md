# mii-exa-test-data-patient-1-icu-score-rass-dar-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-patient-1-icu-score-rass-dar-1**

## Example Observation: mii-exa-test-data-patient-1-icu-score-rass-dar-1
...
**identifier**: `https://www.charite.de/fhir/sid/icu-observation-id`/icu-score-rass-dar-1
...
RASS unter kontinuierlicher Muskelrelaxierung (Cisatracurium-Perfusor) nicht beurteilbar; Neubewertung nach Relaxansstopp.
