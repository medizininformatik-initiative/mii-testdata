# mii-exa-test-data-mikrobio-molekulare-pathogenlast-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-mikrobio-molekulare-pathogenlast-1**

## Example Observation: mii-exa-test-data-mikrobio-molekulare-pathogenlast-1
...
Profile: [MII PR Mikrobio Molekulare Pathogenlast](https://simplifier.net/resolve?scope=de.medizininformatikinitiative.kerndatensatz.complete@2027.0.0-ballot.19&canonical=https://www.medizininformatik-initiative.de/fhir/modul-mikrobio/StructureDefinition/mii-pr-mikrobio-molekulare-pathogenlast)
...
**code**: SARS-CoV-2 (COVID-19) N gene [#/volume] (viral load) in Respiratory system specimen by NAA with probe detection
...
**effective**: 2026-04-03 18:00:00+0200

**issued**: 2026-04-03 19:00:00+0200
...
Hohe Pathogenlast — klinische Relevanz mit Behandelndem besprechen.
...
| :--- | :--- | :--- | :--- |
| - | **Low** | **High** | **Text** |
| * | 0 Copies/mL (Details: UCUM code1/mL = '1/mL') | 500 Copies/mL (Details: UCUM code1/mL = '1/mL') | Nachweisgrenze des Assays |
