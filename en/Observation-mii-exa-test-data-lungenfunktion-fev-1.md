# mii-exa-test-data-lungenfunktion-fev-1 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-lungenfunktion-fev-1**

## Example Observation: mii-exa-test-data-lungenfunktion-fev-1
...
| :--- | :--- | :--- |
| - | **Low** | **High** |
| * | 2.31 L (Details: UCUM codeL = 'L') | 3.39 L (Details: UCUM codeL = 'L') |

**hasMember**: 

* [Observation Forced expired volume in 1 second (observable entity)](Observation-mii-exa-test-data-lungenfunktion-fev-prov-1.md)
* [Observation Forced expired volume in 1 second (observable entity)](Observation-mii-exa-test-data-lungenfunktion-fev-prov-2.md)
...
> **component****code**: Expected forced expired volume in 1 second (observable entity)**value**: 2.85 L (Details: UCUM codeL = 'L')

> **component****code**: Percent predicted forced expired volume in one second (observable entity)**value**: 74 % (Details: UCUM code% = '%')

> **component****code**: Z-score calculation technique (qualifier value)**value**: -1.9
