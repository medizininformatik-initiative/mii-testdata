# mii-exa-test-data-medication-ibuprofen - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-medication-ibuprofen**

## Example Medication: mii-exa-test-data-medication-ibuprofen
...
| :--- | :--- | :--- |
| - | **Item[x]** | **Strength** |
| * | Ibuprofen-ᴅʟ-Lysin (1:1) | 400 mg (Details: UCUM codemg = 'mg')/1 1 (Details: UCUM code1 = '1') |
...
```json
{
  ...
  "id" : "mii-exa-test-data-medication-ibuprofen",
  "meta" : {
