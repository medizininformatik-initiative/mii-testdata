# mii-exa-test-data-patient-1-labobs-2 - MII KDS Test Data v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-test-data-patient-1-labobs-2**

## Example Observation: mii-exa-test-data-patient-1-labobs-2
...
**identifier**: Observation Instance Identifier/LO_000002
...
**code**: Erythrocytes [#/volume] in Blood
...
Erythrozyten EDTA-Blut Impedanzmessung
...
| * | 4.3 /picoliter (Details: UCUM code/pL = '/pL') | 5.8 /picoliter (Details: UCUM code/pL = '/pL') | Normal Range | Male (finding) | 18-65 year |
